...
def groupitem_deeplink_handler(msg):
    ...
    # ==== SAKO NA 1: SANARWAR BANKI KAWAI ====
    try:
        bot.send_message(
            uid,
            f"""SANARWA 🔔📢
Masu amfani da bank transfer 
An sabunta sunan bankin Indulge MFB 
Sabon sunan banking: Nuvion MFB
Nuvion MFB✅
Nuvion MFB✅

Idan kun duba Indulge baku gani ba karku damu
Bankin sun chanja suna zuwa 
(Nuvion MFB)"""
        )
    except Exception:
        pass

    # ==== SAKO NA 2: AINIHIN SAKON ORDER NA DA DA BUTTONS ====
